...
#
#   <data dir>     - Matlab data directory to process. Expects <data dir> to contain a folder named 
#                    "Matlab" which contains matlab files you wish to convert to a csv.
#                    This program will create a folder named CSV, which will contain the outputs
